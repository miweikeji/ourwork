 ...
 */
public class ConstructionFragment extends Fragment implements AdapterView.OnItemClickListener, AbsListView.OnScrollListener {
    ...
    private void netWorkData() {
        ...
        HttpRequest.myWorks(getActivity(), UserUtil.getUserId(getActivity()), "0", p, new ICallback<MyWorksListResult>() {
            @Override

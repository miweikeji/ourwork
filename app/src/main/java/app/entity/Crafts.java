...
public class Crafts{
    ...
    public int getCworkold() {
        return cworkold;
    }

    public void setCworkold(int cworkold) {
    ...
    public int getTruecwork() {
        return truecwork;
    }

    public void setTruecwork(int truecwork) {
    ...
    public float getOverallattitude() {
        return overallattitude;
    }

    public void setOverallattitude(float overallattitude) {
    ...
    public void setOverallquality(float overallquality) {
